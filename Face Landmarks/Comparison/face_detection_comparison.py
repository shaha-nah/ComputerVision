"""
    ...
    To find faces in image -> python face_detection_comparison.py -i <input-image>
    To find faces realtime -> python face_detection_comparison.py -i <input-image> -w <weight>
...
if __name__ == "__main__":
    ...
    HOME = "C:\ComputerVision\opencv\Test1\Lab18\Task33"
