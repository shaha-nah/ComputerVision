"""
    ...
    To find faces in image -> python face_detection_cnn.py -i <input-image> -w mmod_human_face_detector.dat
    To find faces realtime -> python face_detection_cnn.py -w mmod_human_face_detector.dat
